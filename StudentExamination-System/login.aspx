    ...
    <div id="main_box">
        ...
        <div id="panel_box">
            <div id="student" class="panel">
                ...
                <asp:Button ID="stu_login" CssClass="login_btn" runat="server" Text="登录" />
            </div>
            <div id="teacher" class="panel">
                ...
                <asp:Button ID="teacher_login" CssClass="login_btn" runat="server" Text="登录" />
            </div>
            <div id="admin" class="panel">
                ...
                <asp:Button ID="admin_login" CssClass="login_btn" runat="server" Text="登录" />
            </div>
            <div id="register" class="panel" style="display: block">
                ...
                <div id="stu_register" class="information" style="display: block;">
                    <div class="information_box clear">
                        ...
                        <asp:TextBox ID="re_stu_psw" CssClass="re_textbox" runat="server"></asp:TextBox>

                        <span class="re_title">确认密码</span>
                        <asp:TextBox ID="re_stu_repsw" CssClass="re_textbox" runat="server"></asp:TextBox>
                    ...
                    <asp:Button ID="re_stu_btn" CssClass="login_btn register_btn" runat="server" Text="注册" />
                </div>
                ...
                <div id="teacher_register" class="information">
                    <div class="information_box clear">
                        ...
                        <span class="re_title">密 码</span>
                        <asp:TextBox ID="re_teacher_psw" CssClass="re_textbox" runat="server"></asp:TextBox>

                        <span class="re_title">确认密码</span>
                        <asp:TextBox ID="re_teacher_repsw" CssClass="re_textbox" runat="server"></asp:TextBox>
                    ...
                    <asp:Button ID="re_teacher_btn" CssClass="login_btn register_btn" runat="server" Text="注册" />
                </div>
                ...
                <div id="admin_register" class="information">
                    <div class="information_box clear">
                        ...
                        <span class="re_title">密 码</span>
                        <asp:TextBox ID="re_admin_psw" CssClass="re_textbox" runat="server"></asp:TextBox>

                        <span class="re_title">确认密码</span>
                        <asp:TextBox ID="re_admin_repsw" CssClass="re_textbox" runat="server"></asp:TextBox>
                    ...
                    <asp:Button ID="re_admin_btn" CssClass="login_btn register_btn" runat="server" Text="注册" />
                </div>
